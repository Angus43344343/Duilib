...
namespace DuiLib
{
	...
	private:
		...
		//CTreeNodeUI* CalLocation(CTreeNodeUI* _pTreeNodeUI);//zm这里计算缩进的时机不对
		CTreeNodeUI* SetNodeAttr(CTreeNodeUI* _pTreeNodeUI);//zm
	...
	public:
		...
		virtual void SetItemIndent(UINT uiIndent);//zm
		virtual UINT GetItemIndent();//zm
