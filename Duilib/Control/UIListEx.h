...
namespace DuiLib {
	...
	class UILIB_API CListTextExElementUI : public CListLabelElementUI
	{
		DECLARE_DUICONTROL(CListTextExElementUI)
	...
	public:
		...
		DWORD GetTextColor(int iIndex) const;//zm
		void SetTextColor(int iIndex, DWORD dwTextColor);//zm
