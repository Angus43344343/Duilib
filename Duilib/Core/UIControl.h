...
namespace DuiLib {
	...
	public:
		...
		virtual CControlUI* GetParent() const;//获取控件容器VerticalLayout或HorizontalLayout
		...
		virtual void SetResourceText(bool bResource);//用来检索文本ID,做语言切换时使用
		...
		// 图形相关
		LPCTSTR GetGradient();
		void SetGradient(LPCTSTR pStrImage);//设置渐变图片
		...
		void SetForeColor(DWORD dwForeColor);//前景色
		LPCTSTR GetBkImage();
		void SetBkImage(LPCTSTR pStrImage);//背景图片
		LPCTSTR GetForeImage() const;
		void SetForeImage(LPCTSTR pStrImage);//前景图片
		...
		void SetBorderColor(DWORD dwBorderColor);//边框色
		...
		void SetBorderStyle(int nStyle);//边框样式
		DWORD GetFocusBorderColor() const;
		void SetFocusBorderColor(DWORD dwBorderColor);//边框焦点色
		SIZE GetBorderRound() const;
		void SetBorderRound(SIZE cxyRound);//边框圆角

		// 位置相关
		virtual RECT GetRelativePos() const; // 相对(父控件)位置
		virtual RECT GetClientPos() const; // 客户区域（除去scrollbar和inset）
		virtual const RECT& GetPos() const;//相对位置
		virtual void SetPos(RECT rc, bool bNeedInvalidate = true);
		virtual void Move(SIZE szOffset, bool bNeedInvalidate = true);
		virtual int GetWidth() const;
		virtual int GetHeight() const;//
		virtual int GetX() const;
		virtual int GetY() const;//x,y坐标
		virtual bool IsFloat() const;
		virtual void SetFloat(bool bFloat = true);//绝对位置
		...
		virtual void SetEnabled(bool bEnable = true);//控件使能
		virtual bool IsMouseEnabled() const;
		virtual void SetMouseEnabled(bool bEnable = true);//鼠标使能
		virtual bool IsKeyboardEnabled() const;
		virtual void SetKeyboardEnabled(bool bEnable = true);//键盘使能
		...
		virtual void DoPostPaint(HDC hDC, const RECT& rcPaint);//在背景图上绘制控件
