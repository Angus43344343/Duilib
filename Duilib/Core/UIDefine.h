...
#define DUI_HAND            32649
	...
	//Duilib事件类型(UIManager在窗口消息过程中将系统窗口消息转换成Duilib事件)
...
#define DUI_MSGTYPE_DROP					(_T("drop"))//zm
	//////////////////////////////////////////////////////////////////////////
...
#define  DUI_CTR_GIFANIM_EX                      (_T("GifAnimEx"))//zm
...
#define  DUI_CTR_IPADDRESS_EX                    (_T("IPAddressEx"))
...
#define  DUI_CTR_LISTTEXTELEMENT_EX              (_T("ListTextExElement"))//zm
